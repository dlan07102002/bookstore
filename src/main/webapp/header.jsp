			...
			<form class="d-flex" role="search">
				...
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<a href="#">My order</a> <a href="#">Notification</a> 
						<a href="<%=url%>/customer/changeAvatar.jsp">change avatar</a> 
						<a
							href="<%=url%>/customer/changeUserInfo.jsp">Change user info</a>
						<a href="<%=url%>/customer/changePassword.jsp">Change password</a>
						<a href="<%=url%>/customer?action=logout"
